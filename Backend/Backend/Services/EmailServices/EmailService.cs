...
namespace FIN.Service.EmailServices
{
    public class EmailService : IEmailService
    {
        ...
        public async Task VerificationMailAsync(string toEmail, string subject, string htmlMessage)
        {
        ...
        public async Task SendOtpEmailAsync(string email, string otp)
        {
            ...
            await VerificationMailAsync(email, "Your StockVault OTP Code", htmlMessage);
        }
